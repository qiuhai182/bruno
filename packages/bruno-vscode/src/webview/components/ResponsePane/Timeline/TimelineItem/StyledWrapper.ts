...
const StyledWrapper = styled.div`
  ...
  .tl-row:hover {
    background: ${(props) => rgba(props.theme.colors.text.muted, 0.06)};
  }
  .tl-row.is-expanded {
    background: ${(props) => rgba(props.theme.colors.text.muted, 0.1)};
  }
  ...
  .tl-headers-table tr:hover {
    background: ${(props) => rgba(props.theme.colors.text.muted, 0.05)};
  }
  .tl-headers-table td {
